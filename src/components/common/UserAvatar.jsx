...
export default function UserAvatar({ variant = 'desktop', onOpenSettings, onOpenReminder, onOpenChangelog, onOpenSubscription, isOpen: controlledOpen, onOpenChange }) {
  ...
  return (
    <div ref={wrapperRef} className={`user-avatar-wrapper--${variant}`}>
      ...
      >
        ...
        {isMobile && onOpenSubscription && (
          <button className="more-menu-item" onClick={() => { setIsOpen(false); onOpenSubscription(); }}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="more-menu-item-icon">
