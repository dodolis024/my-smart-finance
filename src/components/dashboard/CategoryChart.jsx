...
import { CHART_COLORS, CHART_COLORS_ROSE, CHART_COLORS_GRAY, CHART_COLORS_DAWN, CHART_COLORS_SODA, CHART_COLORS_LAVENDER, CHART_COLORS_SORBET, CHART_COLORS_PEACH } from '@/lib/constants';
import { useTheme } from '@/hooks/useTheme';
import { formatMoney } from '@/lib/utils';

ChartJS.register(ArcElement, Tooltip);

const THEME_PALETTES = { rose: CHART_COLORS_ROSE, graphite: CHART_COLORS_GRAY, dawn: CHART_COLORS_DAWN, soda: CHART_COLORS_SODA, lavender: CHART_COLORS_LAVENDER, sorbet: CHART_COLORS_SORBET, peach: CHART_COLORS_PEACH };
