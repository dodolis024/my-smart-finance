    ...
    <nav className={`app-sidebar${collapsed ? ' is-collapsed' : ''}`} aria-label={t('layout.mainNav')}>
      ...
      <div className="app-sidebar__nav">
        ...
        >
          ...
          {!collapsed && <span>{t('layout.home')}</span>}
        </button>
        ...
        >
          ...
          {!collapsed && <span>{t('layout.split')}</span>}
        </button>
        ...
        <button
          type="button"
          className={`app-sidebar__item${!modalOpen && currentPath === '/yearly-review' ? ' is-active' : ''}`}
          onClick={() => navigate('/yearly-review')}
          title={t('yearlyReview.bannerTitle')}
        >
          <YearReviewIcon className="app-sidebar__icon" />
          {!collapsed && <span>{t('layout.yearReview')}</span>}
        </button>
        ...
        >
          ...
          {!collapsed && <span>{t('layout.changelog')}</span>}
        </button>
