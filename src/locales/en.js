const en = {
  ...
  dashboard: {
    ...
    noExpenseData: 'No spending recorded {period}',
    noPaymentData: 'No transactions recorded {period}',
    categoryDetailCount: '{count} records',
    categoryDetailShare: '{percent}% of spending {period}',
    categoryDetailEmpty: 'No transactions in this category {period}',
    categoryDetailSortBy: 'Sort',
    categoryDetailSortDate: 'Date',
    categoryDetailSortAmount: 'Amount',
    paymentDetailShare: '{percent}% of payments {period}',
    paymentDetailEmpty: 'No transactions with this payment method {period}',
    ...
    pagerNext: 'Next page',
    yearRowsCapped: 'This year has {count} transactions; only the earliest {limit} are loaded, so the stats cover just those.',
    yearLoadFailed: 'Could not load this year\'s data, please try again later.',
    yearOfflineFallback: 'Yearly data is unavailable offline; switched back to the monthly view',
    exportCsv: 'Export CSV',
    exportCsvAria: 'Export the current list as a CSV file',
    exportConfirmPeriod: 'Export {count} transaction(s) from {label} as a CSV file?',
    ...
    exportMenuPeriod: 'Export {period} ({label})',
  ...
  transaction: {
    ...
    overseasToggle: 'Overseas',
    feeIncluded: 'incl. {fee} fee',
    feeIncludedWithRate: 'incl. {fee} fee · {rate}%',
    twdTotal: 'TWD Total',
    ...
    noTransactions: 'No transactions recorded {period}',
    noFilterResults: 'No matching transactions',
    weekLabels: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
    dateGroupLabel: '{date} ({weekday})',
    dateGroupCount: '{count} record(s)',
  ...
  creditCard: {
    ...
    liveDataHintYear: 'Showing live card status, not data for {year}',
  ...
  settings: {
    ...
    account: {
      ...
      overseasFeeRateLabel: 'Foreign Transaction Fee (%)',
      overseasFeeRateHint: 'The extra percentage your bank charges on overseas purchases. Leave blank if this card has no fee.',
      overseasAutoCheckLabel: 'Tick "Overseas" automatically for foreign-currency purchases',
      overseasFeeRateError: 'Enter a fee between 0 and 10',
    ...
    notification: {
      ...
      reminderDesc: 'Get a daily email at your set time reminding you to log, so your streak stays unbroken.',
      enableEmail: 'Enable Email Reminder',
      timezone: 'Timezone',
      detectedTimezone: 'Detected timezone: {tz}. Click to use.',
      reminderTime: 'Reminder time',
      pushDesc: 'Turn this on to get split group updates and credit card reminders on this device.',
      ...
      statusOff: 'Off',
      reminderStatus: 'Daily at {time}',
      pushStatusOn: 'On for this device',
      pushStatusUnsupported: 'Not supported',
      pushStatusBlocked: 'Blocked',
      creditStatusPayment: '{days} days before due',
      creditStatusUsage: 'Alert at {pct}%',
      creditStatusBoth: '{days}d before due · {pct}%',
    },
    ...
    subscription: {
      ...
      emptyHint: "We'll log the charge for you on each renewal date.",
  ...
  split: {
    ...
    syncCol: 'Sync',
    syncItemToggle: 'Sync "{title}" to personal ledger',
    excludedCount: '{n} excluded from your ledger',
    itemRemovedFromLedger: 'Removed from your ledger',
    toggleSyncFailed: "Couldn't update. Please try again.",
    ...
    hasNewExpenses: 'Split details changed, ledger not updated',
    ledgerRecord: 'Ledger: ',
    latest: 'Latest: ',
    updating: 'Updating...',
  ...
  periodPicker: {
    ...
    nextYear: 'Next year',
    today: 'Back to {period}',
    granularityAria: 'View period unit',
    tabMonth: 'Month',
    tabYear: 'Year',
    prevYears: 'Previous years',
    nextYears: 'Next years',
    yearOfflineHint: 'Only the current month is available offline',
    yearNoData: 'No transactions in this year',
    monthNoData: 'No transactions in this month',
  },
  ...
  errors: {
    ...
    SPLIT_NAME_REQUIRED: 'The group name and your name cannot be empty',
